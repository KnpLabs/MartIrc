...
MartIrc.prototype.createIrcServerForClient = function(client, ircHost, ircPort, nick, encoding, channels) {
    ...
    var bridgeServer = new ircBridge({
        server: ircHost
        , port: ircPort
        , nick: nick
        , encoding: encoding
    ...
    //@TODO remove it, should be done on the client side
    ...
    //@TODO: remove, we should just push the IRC message to clients
    //clients will have to parse this message
